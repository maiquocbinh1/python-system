...
class Lesson:
    def __init__(self,root):
        ...
        time_img = Label(self.root, bg="white")
        ...
        self.heading = Label(self.root, text="Quản lý thông tin lịch học", font=("yu gothic ui", 28, "bold"), bg="white", fg="black", bd=5, relief=FLAT)
